...
export default function Page() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'sticky', top: 0, zIndex: 10, background: 'rgba(12,21,53,0.92)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        ...
        <div style={{ display: 'flex', overflowX: 'auto', scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          {TABS.map(t => (
